      ...
      <div className="grid grid-cols-12 gap-4">
        ...
        <div className="col-span-12 lg:col-span-9 grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard icon={CheckCircle2} label="Выполнено задач" value={stats.completedTasks}
            variant="success" />
          <StatCard icon={Users} label="Соцобъекты под угрозой" value={stats.socialAtRisk}
            subtitle="активных инцидентов на школах, садах, поликлиниках"
            variant={stats.socialAtRisk > 0 ? 'warning' : 'default'}
            onClick={() => navigate('/app/incidents?social=1')} />
