              ...
              <div className="tablet-screen rounded-[2rem] border border-border bg-background p-4 shadow-inner">
                ...
                <div className="grid gap-2.5">
                  ...
                  <div className="rounded-2xl border border-border bg-card p-3">
                    ...
                    <div className="flex h-16 w-full flex-nowrap items-end gap-1.5 overflow-hidden sm:h-20 sm:gap-2">
                      {barMetrics.slice(0, 8).map((height, index) => (
                        <span
                          key={height + index}
                          className="block min-w-0 flex-1 basis-0 rounded-t-lg bg-gradient-to-t from-primary/80 to-primary/40"
                          style={{ height: `${height}%` }}
                        />
                      ))}
                    </div>
